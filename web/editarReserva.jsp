					...
					<div class="booking-form">
						<div class="booking-bg">
                                                    <div class="form-header">
                                                        <h2>Actualiza tu reserva aqui</h2>
							...
							<div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                        ...
                                                                        <input type="hidden" name="idreserva" value="${requestScope.idreserva}" >
                                                                        <input type="hidden" name="idmesa" value="${requestScope.idmesa}" >
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
							...
							<div class="form-btn">
                                                            <input type="submit" class="submit-btn" value="Editar Reserva">
							</div>
                                                        <br>
                                                        <div class="col-md-12 ">
                                                            <div class="form-group">
                                                                <p class="text-right"><a href="editarMesaServlet?idmesa=${requestScope.idmesa}">Cancelar</a></p>
                                                            </div>
                                                        </div>
						</form>
